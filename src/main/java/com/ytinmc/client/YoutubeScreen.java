...
extends Screen {
    ...
    private double getDpiScale() {
        ...
        if (mc.getWindow() != null) {
            ...
            return Math.max(1.0, (double)guiScale);
        }
        return 1.5;
    }
    ...
    private void resizeBrowser() {
        if (this.browser != null && this.width > 50 && this.height > 50) {
            ...
            int bW = (int)((double)this.getBrowserWidth() * dpi);
            int bH = (int)((double)this.getBrowserHeight() * dpi);
    ...
    private int getRelativeBrowserX(double mouseX) {
        return (int)((mouseX - (double)this.getBrowserX()) * this.getDpiScale());
    }

    private int getRelativeBrowserY(double mouseY) {
        return (int)((mouseY - (double)this.getBrowserY()) * this.getDpiScale());
    }
